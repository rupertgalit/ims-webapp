...
<body>
  ...
  <p>Oops! This page doesn’t exist.</p>
    ...
    <div id="controls">
        <div class="controls">
            <input id="btnToggleView" class="icon" type="checkbox" name="toggleView" onclick="toggleView()" disabled>
            <input id="btnToggleResolution" class="" type="checkbox" name="toggleResolution" onchange="toggleResolution()" disabled>
