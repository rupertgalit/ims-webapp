                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-line nav-color-secondary" id="line-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="line-home-tab" data-bs-toggle="pill" href="#line-home"
                                    role="tab" aria-controls="line-home" aria-selected="true">Cash In</a>
                            <li class="nav-item">
                        ...
                        <div class="tab-content mt-3 mb-3" id="line-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="line-home" role="tabpanel"
                                ...
                                <div class="row mb-3">
                                    <form method="POST" action="soa-cashin" class="col-md-12 d-flex flex-wrap">
                                ...
                                <div class="tab-pane fade" id="line-profile" role="tabpanel"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <form id="referenceForm" class="col-md-12 d-flex flex-wrap">
                                            <div class="col-md-3 mb-3">
                                                <label for="start-date-cashin">Merchant Number: </label>
                                                <div class="input-group">
